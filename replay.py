...
class ReplayBuffer(object):
    ...
    """
    def __init__(self, capacity, state_shape, num_actions, s0=None, a=None,
                 r=None, s1=None, terminals=None, rng=None):
        ...
        self.a = a or np.zeros((capacity, num_actions), dtype=np.float32)
